...
Shared with the Claude skill, in the repo at
`skills/claude/annotate/references/`: `building-pages.md` (markdown format,
§1) · `decision-cards.md` · `cli-reference.md` · `architecture.md` ·
