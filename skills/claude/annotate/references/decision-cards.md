...
| `options` | One button each. Object options render `label`; `style` sets primary/default/danger. |
...
| Round bar | Sticky: bottom on mobile, above the rail footer on desktop. Shows "Finish review (N)" and "D of M decided". |
