...
{"ts":"2026-06-28T15:04:00Z","event":"round_submitted","slug":"schema","comment_ids":["abc","def"],"verdict_counts":{"accept":2,"reject":0,"changes":0,"comment":0,"select":0},"undecided_ids":[],"by":"user@example.com"}
```
